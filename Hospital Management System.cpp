...
/*This program performs following operetions/functions:

1) On Pressing 1 it will call admit patient function which will admit patient 
with his/her folowing details:
Patient_ID
Name
Age
Gender
Diease he/she is suffering From.

2) On Pressing 2 it will call Patients List function which will print following details of patient:
...
3) On Pressing 3 it will call Patients Search by ID function which will search in the vector for the ID.
if found then it will store in the variable index this indus will variable will be used as index
to printing following deatils of patient:
...
4) On Pressing 4 it will call Patients with same disease function which will ask the user the user
to enter the disease then It will search in the vector if it is found then it will store its index in
another vector.

If the size of the vector in which we were storing the indecies is not equal to zero then it will
print the following details of the patient
...
From every index stored in the vector.

5) On pressing 5 it will call the discharge patient function which will ask the user to
enter the ID of patient you want to discharge. If Id is avalible in the ID vector then it will remove
it using erase function.


6) On Pressing 6 it will Display list of Doctors function which will print the list of doctors with
...
int main()
{
  ...
  // Doctors Details:
  string Doctors_Name[5] = {"Dr Abdullah Kaleem", "Dr Muhammad Ammar Qaisar", "Dr Choomu Areeb Khan", "Dr Muhammad Almas Manzoor", "Dr Muhammad Moin Juddu"};
  ...
  cout << "Thank You For Chosing Our Serivce! " << endl << endl;
